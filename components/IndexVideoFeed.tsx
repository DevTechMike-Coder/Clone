...
const FEED_ITEMS: CardItem[] = [
  {
    ...
    name: "John",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis doloremque ut at commodi, natus sit amet.",
    image: require("@/assets/test/5624808.jpg"),
  },
  {
    id: "2",
    name: "Amara",
    description:
      "Omnis alias optio modi? Non culpa ut voluptatem explicabo doloremque excepturi tenetur?",
    image: require("@/assets/test/5624808.jpg"),
  },
  {
    id: "3",
    name: "Micah",
    description:
      "Eos aspernatur, omnis alias optio modi. Natus sit amet, perspiciatis doloremque.",
    image: require("@/assets/test/5624808.jpg"),
  },
];
